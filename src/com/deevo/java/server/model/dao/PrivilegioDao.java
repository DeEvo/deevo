...
import com.deevo.java.server.model.entity.Privilegio;
...
public class PrivilegioDao {
	...
	public boolean existePrivilegio(Privilegio privilegio) {
		...
		public void createPrivilegio(Privilegio privilegio) {
			...
			EntityTransaction tx = em.getTransaction();
			 ...
			 try {
			  ...
			  public Privilegio retrievePrivilegio(Privilegio privilegio) {
			...
			public List<Privilegio> retrievePrivilegios() {
