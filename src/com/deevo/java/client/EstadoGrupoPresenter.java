...
public class EstadoGrupoPresenter extends
	...
	@ProxyCodeSplit
	@NameToken(NameTokens.estadogrupo)
	public interface MyProxy extends ProxyPlace<EstadoGrupoPresenter> {
	}

	@Inject
	public EstadoGrupoPresenter(final EventBus eventBus, final MyView view,
			final MyProxy proxy) {
